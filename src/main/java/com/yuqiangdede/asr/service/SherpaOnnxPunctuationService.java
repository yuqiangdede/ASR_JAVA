...
public class SherpaOnnxPunctuationService {
    ...
    private static final Logger log = LoggerFactory.getLogger(SherpaOnnxPunctuationService.class);
    ...
    public SherpaOnnxPunctuationService(AsrPathResolver pathResolver) {
