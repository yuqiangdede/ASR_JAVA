...
public class SherpaOnnxAsrService {
    ...
    private static final Logger log = LoggerFactory.getLogger(SherpaOnnxAsrService.class);
    ...
    public SherpaOnnxAsrService(AsrPathResolver pathResolver) {
    ...
    public synchronized void warmup() {
        try {
            validateModelFiles();
            ensureRecognizer(java.util.Collections.emptyList());
    ...
    private List<String> normalizeHotwords(List<String> hotwords) {
        ...
        return java.util.Collections.unmodifiableList(new java.util.ArrayList<String>(values));
    }
    ...
    Path selectModelFile(String prefix) {
        try (java.util.stream.Stream<Path> stream = Files.list(pathResolver.getModelDir())) {
    ...
    private boolean isStreamingModel() {
        return pathResolver.isStreamingModel();
    }
